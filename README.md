...
|:--|--:|--:|--:|
|nertivia markup|2500|232.251|0.093|
|nertivia markup with inserted text spans|2500|212.853|0.085|
|/x/markdown@v2.0.0 (based on an older version of Marked)|2500|375.133|0.150|
<!-- BENCHMARKS END -->