...
|:--|--:|--:|--:|
|nertivia markup|2500|154.953|0.062|
|nertivia markup with inserted text spans|2500|161.374|0.065|
|/x/markdown@v2.0.0 (based on an older version of Marked)|2500|305.459|0.122|
<!-- BENCHMARKS END -->