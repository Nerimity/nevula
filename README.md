...
|:--|--:|--:|--:|
|nertivia markup|2500|204.801|0.082|
|nertivia markup with inserted text spans|2500|200.790|0.080|
|/x/markdown@v2.0.0 (based on an older version of Marked)|2500|355.435|0.142|
<!-- BENCHMARKS END -->